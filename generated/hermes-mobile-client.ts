...
export class HermesMobileClient {
  ...
  getRunActivity(run_id: string, options: RequestOptions = {}): Promise<unknown> { return this.request("GET", this.path("/p/{profile}/v1/mobile/runs/{run_id}/activity", { profile: this.profile, run_id: run_id }), options); }
